...
const YUPOO_LOCK_CODES = {
  ...
  'aj-dongli': '888886',      // Tênis Esportivos
};
...
app.get('/api/categories', async (req, res) => {
  ...
  const CATEGORY_DB_ALIASES = {
    ...
    'tenis esportivos - senha: 888888':  'Tênis Esportivos',
    'tenis esportivos - senha: 888886':  'Tênis Esportivos',
...
// DELETE /api/admin/products/:id — Inativação lógica (equivale ao Pages Function)
app.delete('/api/admin/products/:id', requireAuth, async (req, res) => {
  ...
  try {
    ...
    console.error('[API] DELETE /api/admin/products/:id error:', err.message);
    res.status(500).json({ error: 'Erro interno' });
  }
});
