          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0 group relative z-10 mb-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="flex items-center gap-1.5 mt-1">
                <span className="h-px w-4 bg-gradient-to-r from-transparent to-brand-purpleLight/70" />
                <span className="font-display text-[11px] font-black uppercase tracking-[0.3em] bg-gradient-to-r from-brand-purpleLight via-brand-purpleNeon to-brand-purpleLight bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(168,85,247,0.45)]">
                  Outlet
                </span>
                <span className="h-px w-4 bg-gradient-to-l from-transparent to-brand-purpleLight/70" />
              </span>
            </div>
          </Link>
